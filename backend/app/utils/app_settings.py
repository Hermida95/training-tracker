...
def get_program_start_date(db: Session) -> datetime.date:
    """Fecha de inicio del ciclo de periodización de 4 semanas.
    ...
    """
    raw = get_setting(db, PROGRAM_START_DATE_KEY)
    if raw:
    ...
    set_setting(db, PROGRAM_START_DATE_KEY, monday_this_week.isoformat())
